...
int commData=Integer.parseInt(comm.getText().toString());
int rateData=Integer.parseInt(rate.getText().toString());
...
int creditData=Integer.parseInt(credit.getText().toString());
...
//String query1="insert into customer values("+custnoData+",'"+custnameData+"','"+custstateData+"',"+creditData+");";
String query1="insert into customer values("+custnoData+",'"+custnameData+"','"+custstateData+"',"+creditData+","+repnoData+");";
